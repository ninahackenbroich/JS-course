...
const dogsEatTooLittl = dogs.filter(dog => dog.curFood < dog.recommendedFood);
console.log(dogsEatTooLittl);
const ownersEatTooLittl = dogsEatTooLittl.map(dog => dog.owners).flat();
